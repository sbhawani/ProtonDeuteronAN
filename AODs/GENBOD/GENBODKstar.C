...
void GENBODKstar() {
  TString FileName = "/home/sbhawani/cernbox/ProtonDeuteron/Outputs/CATSOutput/DecayMatrices/DeltaDecay1.root";
  ...
  const double MomMeanProton = 0.7;   // some assumption
  const double MomSpreadProton = 0.3; // some assumption

  const double MomMeanPion = 2.5;   // some assumption
  const double MomSpreadPion = 0.6; // some assumption
