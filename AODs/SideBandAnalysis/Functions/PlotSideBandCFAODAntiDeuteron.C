...
void PlotSideBandCFAOD() {
  TString PathtoFolder =
      "/home/sbhawani/cernbox/ProtonDeuteron/Outputs/AODs/SideBandAnalysis/SideBandStudyInPtBins/Version3.0/";
  TString OutputdirName ="/home/sbhawani/cernbox/ProtonDeuteron/Outputs/AODs/SideBandAnalysis/SideBandStudyInPtBins/Version3.0/PlotsVersion3.0/";
  ...
  for ( int pTBin = 0; pTBin < MaxpTBin; ++pTBin) {
        ...
        Signal->GetYaxis()->SetRangeUser(0.0, 3.2);
