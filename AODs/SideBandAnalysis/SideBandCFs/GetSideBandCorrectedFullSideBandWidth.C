...
void GetSideBandCorrectedFullSideBandWidth() {
  TString InputdirName =
        "/home/sbhawani/cernbox/ProtonDeuteron/Outputs/AODs/ComparewithMichael/Sidebandcomparision/Bhawani/FullNormFullSidebandWidths/CFs/";
  ...
  TString OutputdirName =
      "/home/sbhawani/cernbox/ProtonDeuteron/Outputs/AODs/ComparewithMichael/Sidebandcomparision/Bhawani/FullNormFullSidebandWidths/Outputs/";
  ...
  TH1F *CorrectCkpd = new TH1F("CorrectCk","CorrectCk",74,4.0,3000);
  TH1F *CorrectCkApAd = new TH1F("CorrectCkApAd","CorrectCkApAd",74,4.0,3000);

  TH1F *rescalepd = new TH1F("rescalepd","rescalepd",74,0.0,3004);
  TH1F *rescaleapad = new TH1F("rescaleapad","rescaleapad",74,0.0,3000);

  TH1F *combinedpd_apad = new TH1F("combinedpd_apad","combinedpd_apad",74,0.0,3000);
...
//just for renormalization purpose
  ...
  //actual correlations
      Signalpd =GetCF(Form("%s%s",InputdirName.Data(),"FullWidthSignal_pd.root"));
      SignalApAd =GetCF(Form("%s%s",InputdirName.Data(),"FullWidthSignal_apad.root"));
