...
void GetCkCorrected(TH1F *hSignal, TH1F *hLSB, TH1F *hRSB,TH1F*CorrectCk,
  ...
  leg->SetHeader("norm: 0-3000 MeV/c");
  h0->SetTitle(0);
  h1->SetTitle(0);
  h2->SetTitle(0);
  ...
  //h1->SetTitle(Form("correlation function (%.1f < #it{p}_{T} < %.2f)", 0.5, 4.05));
  gStyle->SetTitleX(0.1f);
  gStyle->SetTitleW(0.9f);
  h1->GetYaxis()->SetTitle("#it{C}(#it{k}*)");
  h1->GetXaxis()->SetTitle("#it{k}* (MeV/#it{c})");


  //h0->SetTitle(Form(" Final correlation function (%.1f GeV/c < #it{p}_{T} < %.2f GeV/c)", 0.5, 4.05));
...
void CombinedPlot(TH1F *histo1,TH1F *histo2,TH1F *histo8,TString OutputdirName, TString Outputfilename){
  ...
  TString name = "p#minus#kern[0.4]{d} #oplus #bar{p}#minus#kern[0.4]{#bar{d}}";
  ...
  histo8->GetYaxis()->SetTitle("#it{C}(#it{k}*)");
...
TH1F* Rescale(TH1F *h0, float rescale, TString OutputdirName,
  ...
  leg1->SetHeader("norm: 0-3000 MeV/c");
  ...
  //h01->SetTitle(Form("correlation function (%.1f < #it{p}_{T} < %.2f)", 0.5, 4.05));
  gStyle->SetTitleX(0.1f);
  gStyle->SetTitleW(0.9f);
  h01->GetYaxis()->SetTitle("#it{C}(#it{k}*)");
  h01->GetXaxis()->SetTitle("#it{k}* (MeV/#it{c})");
  h01->Draw("");
  h11->Draw("same");
