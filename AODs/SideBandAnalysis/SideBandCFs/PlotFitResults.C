...
void PlotFitResults() {
  ...
  TFile *_file0 = TFile::Open("/home/sbhawani/cernbox/ProtonDeuteron/Outputs/AODs/Correlations/LowpT1p4/FITCATS/LatestCkFITPd_R_1p0Correct.root", "READ");
  ...
  TF1 *Fit =(TF1  *) _file0->FindObjectAny("fit_pd");
